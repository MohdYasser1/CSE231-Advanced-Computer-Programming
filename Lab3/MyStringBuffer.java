...
//Create a class called MyStringBuffer
public class MyStringBuffer {
    ...
    //A method that erases some characters from the array
    void erase(int index, int length){
        ...
        //Overwite the string with the new one
        this.s = sera;
    }
    //A method the inserts charcters to the string
    void insert(int index, String str){
        ...
        //Overwite thestring with the new one
        this.s = snew;
    }
}
